...
/* a es igual a la los argumentos de tiene el listado que son de tipo entero */
...
/* se llama la funcion _putchar y se pasa por parametro lo que esta en x, el '0'
convirte el numero en codigo ascci
*/
_putchar (x + '0');
